...
git add README.md docs .gitignore demo_mlops/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-4394007684464835.15.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-925694724636289.9.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[demo_mlops/databricks.yml](../demo_mlops/databricks.yml) file.
...
Follow the instructions in [demo_mlops/resources/README.md](../demo_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../demo_mlops/resources/README.md)  to propose, test, and deploy
