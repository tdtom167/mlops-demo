...
Opening a pull request will trigger a[workflow](../.github/workflows/demo_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-4394007684464835.15.azuredatabricks.net/explore/data/models/staging/demo_mlops/demo_mlops-model)
* [Prod model in UC](https://adb-925694724636289.9.azuredatabricks.net/explore/data/models/prod/demo_mlops/demo_mlops-model)
. 
